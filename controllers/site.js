...
exports.index = function (req, res, next) {
  ...
  var render = function (tags, topics, hot_topics, tops, no_reply_topics, pages) {
  ...
  var proxy = EventProxy.create('tags', 'topics', 'hot_topics', 'tops', 'no_reply_topics', 'pages', render);
  proxy.fail(next);
  // 取标签
...
exports.extremes = function (req, res, next) {
  var page = parseInt(req.query.page, 10) || 1;
  var keyword = req.query.q || ''; // in-site search
  if (Array.isArray(keyword)) {
    keyword = keyword.join(' ');
...
exports.members = function (req, res, next) {
  ...
  var render = function (hot_topics, stars, tops, no_reply_topics, pages) {
    res.render('members', {
      current_page: page,
      list_topic_count: limit,
      hot_topics: hot_topics,
  ...
  var proxy = EventProxy.create('hot_topics', 'stars', 'tops', 'no_reply_topics', 'pages', render);
  proxy.fail(next);
  // 取标签
